...
function renderlist(data) {
	...
	data.forEach(function(client) {
		...
		info_html += "<td class='list-sty2' style='vertical-align: middle;'>" + client.code + "</td>";
		info_html += "<td class='list-sty2' style='vertical-align: middle;'>" + client.name + "</td>";
		info_html += "<td class='list-sty2' style='vertical-align: middle;'>" + client.regno + "</td>";
		info_html += "<td class='list-sty2' style='vertical-align: middle;'>" + client.regno2 + "</td>";
		info_html += "<td class='list-sty2' style='vertical-align: middle;'>" + client.rep_nm + "</td>";
		info_html += "<td class='list-sty2' style='vertical-align: middle;'>" + client.business_type + "</td>";
		info_html += "<td class='list-sty2' style='vertical-align: middle;'>" + client.item_type + "</td>";
		info_html += "<td class='list-sty2' style='vertical-align: middle;'>" + client.tel + "</td>";
		info_html += "<td class='list-sty2' style='vertical-align: middle;'>" + client.post + "</td>";
		info_html += "<td class='list-sty2' style='text-align:left;'>" + client.addr + ' ' + client.addr2 + "</td>";
		info_html += "<td class='list-sty2' style='vertical-align: middle; text-align:left;'>" + client.email + "</td>";
